...
class _EditTaskBottomSheetState extends State<EditTaskBottomSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    isLightTheme ? LightAppStyle.bottomSheetTitle : DarkAppStyle.bottomSheetTitle;
    final TextStyle hintStyle =
    isLightTheme ? LightAppStyle.hint : DarkAppStyle.hint;
    final TextStyle dateStyle =
    isLightTheme ? LightAppStyle.date : DarkAppStyle.date;
    final Color backgroundColor =
    isLightTheme ? ColorsManager.white : ColorsManager.darkBs;
    final Color buttonBackgroundColor = ColorsManager.blue;
    final Color buttonTextColor =
    isLightTheme ? ColorsManager.white : ColorsManager.black;
                ...
                decoration: InputDecoration(
                  ...
                  enabledBorder: UnderlineInputBorder(
                    borderSide: BorderSide(
                        color: isLightTheme ? ColorsManager.black : ColorsManager.white),
                  ),
                ),
              ),
  ...
  void showTaskDate(BuildContext context) async {
    ...
    final datePickerThemeDark = Theme.of(context).copyWith(
      colorScheme: ColorScheme.dark(
        ...
        surface: ColorsManager.darkBs,
        onSurface: ColorsManager.white,
      ),
      dialogBackgroundColor: ColorsManager.darkBs,
    );
