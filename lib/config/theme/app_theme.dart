...
class AppTheme {
  ...
  static ThemeData dark = ThemeData(
    colorScheme: ColorScheme.fromSeed(
      seedColor: ColorsManager.bgDark,
      primary: ColorsManager.bgDark,
      onPrimary: ColorsManager.darkBs,
    ),
    appBarTheme: AppBarTheme(
      elevation: 0,
      backgroundColor: ColorsManager.blue,
      titleTextStyle: LightAppStyle.appBar.copyWith(color: ColorsManager.black),
    ),
    scaffoldBackgroundColor: ColorsManager.bgDark,
    bottomNavigationBarTheme: const BottomNavigationBarThemeData(
      type: BottomNavigationBarType.fixed,
      backgroundColor: ColorsManager.darkBs,
      elevation: 0,
      selectedItemColor: ColorsManager.blue,
    ...
    floatingActionButtonTheme: const FloatingActionButtonThemeData(
      shape: StadiumBorder(
          side: BorderSide(color: ColorsManager.darkBs, width: 4)),
      backgroundColor: ColorsManager.blue,
      iconSize: 24,
      foregroundColor: ColorsManager.darkBs,
    ),
  );
}
